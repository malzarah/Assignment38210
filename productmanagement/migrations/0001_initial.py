# Generated by Django 3.0.4 on 2020-07-10 10:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier_country_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='productmanagement.Countrie')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('product_Customer', models.ForeignKey(default='none', on_delete=django.db.models.deletion.CASCADE, to='productmanagement.Customer')),
